...
Every distro setup (`ubuntu/`, `fedora/`, `arch/`) installs git, tmux, vim
and neovim, plus whatever system tools that distro is missing. Emacs and
busybox are added where the distro packages them (`fedora/`, `arch/`).
