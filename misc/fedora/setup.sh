...
sudo dnf install -y vim git util-linux passwd cracklib-dicts shadow-utils procps-ng iputils iproute findutils ncurses busybox man man-pages texinfo dnf-plugins-core neovim
