...
Setting my own thing is a hassle, but Neovim community is mature enough,
and Neovim is OOTB enough for me to get rid of as many dependencies as
possible.

## DIY requirements

I have to install LSPs, formatters, DAPs, etc. using other means and not
rely on Mason anymore. Which should've been the case anyway.

On MacOS use Homebrew, on Linux use whatever package manager you have,
