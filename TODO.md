...
- [ ] Remove `nvim/nvim/plugin/mini/00_mini.notify.lua` entirely once
      _ui2 is stable and the native override is confirmed working.
      Currently it's a stub (`return {}`) keeping the slot; can be deleted
